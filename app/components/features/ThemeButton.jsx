...
const ThemeButton = () => {
  ...
  return (
    <Box>
      <Icons onClick={handleClick} icon={<PaletteOutlined/>} sx={{
          color: themeData.buttonText,cursor:'pointer',
          "&:hover": { backgroundColor: themeData.primary },
      }}
     />
          ...
          Object.keys(themes).map((themeKey) => (
            <MenuItem key={themeKey} onClick={() => handleClose(themeKey)}>
              <Box
                ...
                style={{ background: themes[themeKey]?.primary || "#000" }} // Corrected
              />
